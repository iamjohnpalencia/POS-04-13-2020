Public Class MDIFORM
    ...
    Private Sub MDIFORM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            LabelTotalSales.Text = sum(table:="loc_daily_transaction_details WHERE zreading = '" & returndateformat(Format(Now(), "MM/dd/yyyy")) & "' AND active = 1 AND store_id = '" & ClientStoreID & "' AND guid = '" & ClientGuid & "' ", tototal:="total")
